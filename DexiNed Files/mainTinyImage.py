...
os.mkdir('/content/TIN_Edge/a')
os.mkdir('/content/TIN_Edge/f')
os.mkdir('/content/TIN_Edge/a/test')
os.mkdir('/content/TIN_Edge/a/train')
...
def main(args):
    ...
    dataset_val = CustomDataSet('/content/DexiNed_TinyImage/data',transform_test)
