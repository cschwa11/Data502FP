...
class CustomDataSet(Dataset):
    def __init__(self, listT, transform):
        self.listT = listT
...
enhanced_CIFAR10_text = open("/content/enhanced_cifar10.txt", "r")
enhanced_CIFAR10 = enhanced_CIFAR10_text.read()
...
testset=CustomDataSet(enhanced_CIFAR10, transform_test)
